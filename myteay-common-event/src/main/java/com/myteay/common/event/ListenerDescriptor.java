 ...
 * 
 * @author min.weixm
 * @version $Id: ListenerDescriptor.java, v 0.1 May 19, 2020 10:14:34 AM min.weixm Exp $
 */
public class ListenerDescriptor<T, K> implements Serializable {
    ...
    /** 事件监听器 */
    private EventListener<T, K> listener;
     ...
     */
    public EventListener<T, K> getListener() {
        return listener;
    }
     ...
     */
    public void setListener(EventListener<T, K> listener) {
