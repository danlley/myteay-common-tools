...
import com.myteay.common.aop.monitor.logger.exception.ChainedThrowable;
import com.myteay.common.aop.monitor.logger.exception.ChainedThrowableDelegate;

/**
 * 异常的辅助类.
 * 
 * @author min.weixm
 * @version $Id: ExceptionHelper.java, v 0.1 Nov 5, 2017 9:35:45 PM min.weixm Exp $
 */
public class ExceptionHelper {
    ...
    private static class StackTraceAnalyzer {
        ...
        private class StackTraceEntry implements Comparable<Object> {
            private List<Object> lines             = new ArrayList<>(10);
