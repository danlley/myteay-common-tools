...
public class PxGoodsOrderModel implements Serializable {
     ...
     * 
     * @return property value of ActrualPayed
     */
    public String getActrualPayed() {
        return actrualPayed;
    }

    /**
     * Setter method for property <tt>actrualPayed</tt>.
     * 
     * @param ActrualPayed value to be assigned to property actrualPayed
     */
    public void setActrualPayed(String actrualPayed) {
        this.actrualPayed = actrualPayed;
    }
